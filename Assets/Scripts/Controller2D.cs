...
//		Debug.Log("Translate:"+velocity);
	...
	public void Shot (Transform Pos) { // send in the pattern so each gun have differnt pattern maybe??
		...
		GameObject puller = GameObject.Find ("PlayerBullet_Pool");
	...
	public void Dash (Vector3 velocity, float dashForce) {
		UpdateRaycastOrigins();
		collisions.Reset();
		transform.Translate(velocity*dashForce, this.transform);
	}
